...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Data visualization dashboard with real-time analytics, charts, and custom reporting.',
      image: '📊',
    ...
    },
    {
      ...
      description: 'Real-time messaging app with socket.io, user authentication, and message history.',
      image: '💬',
